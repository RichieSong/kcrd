...
// List lists all CronTabs in the indexer.
func (s *cronTabLister) List(selector labels.Selector) (ret []*v1beta1.CronTab, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.CronTab))
	})
	return ret, err
}
...
// List lists all CronTabs in the indexer for a given namespace.
func (s cronTabNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.CronTab, err error) {
...
// Get retrieves the CronTab from the indexer for a given namespace and name.
func (s cronTabNamespaceLister) Get(name string) (*v1beta1.CronTab, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("crontab"), name)
	}
	return obj.(*v1beta1.CronTab), nil
}
